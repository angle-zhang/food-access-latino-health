...
980016 - split into two (keep, handle in code)

9902 - zero population (remove all cts with 0 aland)

5991 - catalina island (remove)

980030 - empty point (need to see why)

Inspecting seemingly missing values at the top - see that they are part of other census tracts (e.g. 901209)

```{r}
# Select a random census tract
set.seed(123)

  tract <- la_ct[la_ct$TRACTCE==980001,]

  print(tract$TRACTCE[[1]])
  # Find adjacent tracts
  dot <- la_ctcent_dat[la_ctcent_dat$TRACTCE==980001,]
  dotwt <- la_ct_wtcent_dat[la_ct_wtcent_dat$TRACTCE==980001,]
